...
<div class="card">
  ...
  <div class="card-body">
    <button class="btn btn-success" onclick="add_data()"><i class="fa fa-plus"></i> Tambah Ustadz</button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/ustadz/ajax_list')?>",
            "type": "POST"
        },
...
function edit_data(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin/ustadz/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin/ustadz/ajax_add')?>";
    } else {
        url = "<?php echo site_url('admin/ustadz/ajax_update')?>";
    }
...
function delete_data(id)
{
    if(confirm('Hapus data ini?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/ustadz/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
        ...
        <form class="form-horizontal" method="POST" id="form">
          <div class="modal-body">
            ...
            <div class="form-group">
                <label class="col-md-12">Nama Ustadz</label>
                <div class="col-md-12">
